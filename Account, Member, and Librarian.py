...
from BookItem import BookLending, BookStatus
...
class Member(Account):
    ...
    def checkout_book_item(self, book_item, ReservationStatus=None):
    ...
    def check_for_fine(self, book_item_barcode, Fine=None):
